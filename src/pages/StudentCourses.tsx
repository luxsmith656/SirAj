            ...
            <div className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-4 shadow-sm">
              ...
              <div className="relative mb-3">
                ...
                <input
                  ...
                  placeholder="Search reviewer tracks..."
                  className="w-full bg-surface-container border border-outline-variant/30 rounded-xl py-2 pl-10 pr-3 text-xs font-medium outline-none focus:border-primary/40"
                />
              </div>

              <div className="space-y-2 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                {allowedSubjects.filter(sub => sub.title.toLowerCase().includes(subjectSearchTerm.toLowerCase())).map((subject) => {

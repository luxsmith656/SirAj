...
export default function CurriculumSettings() {
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen flex antialiased">
       <nav className="hidden md:flex w-64 bg-surface-container-low h-screen fixed z-50 p-6">
      ...
      <main className="flex-1 md:ml-64 bg-surface-container-lowest min-h-screen">
         <header className="h-16 flex items-center px-8 border-b border-surface-container sticky top-0 z-40 bg-surface-container-lowest shadow-sm">
            <h2 className="text-lg font-headline font-semibold">Curriculum Settings</h2>
         </header>

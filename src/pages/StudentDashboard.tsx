...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    if (shouldSync && !isSyncing && navigator.onLine) {
        triggerSync().then(() => {
            localStorage.setItem('did-initial-sync', '1');
        });
    }
  }, [lastSync, isSyncing, triggerSync]);
      ...
      <div className="space-y-8">
        <section className="relative overflow-hidden bg-surface-container-lowest border border-outline-variant rounded-3xl p-6 md:p-8 shadow-sm">
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 min-w-full lg:min-w-[420px] lg:max-w-[450px]">
